...
Here, \text{idol} will automatically create this optimizer at every iteration
...
to~\text{idol} that will, then, automatically do the linearization. We refer
...
\bulletparagraph{Strong-duality-based separation}
