...
DantzigWolfeDecomposition &DantzigWolfeDecomposition::with_pricing_optimizer(const OptimizerFactory &t_pricing_solver) {
...
DantzigWolfeDecomposition &DantzigWolfeDecomposition::with_master_optimizer(const OptimizerFactory &t_master_solver) {
