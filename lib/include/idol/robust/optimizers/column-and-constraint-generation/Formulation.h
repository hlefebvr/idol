...
public:
    ...
    auto second_stage_variables() const { return ConstIteratorForward(m_second_stage_variables); }
    auto second_stage_constraints() const { return ConstIteratorForward(m_second_stage_constraints); }
