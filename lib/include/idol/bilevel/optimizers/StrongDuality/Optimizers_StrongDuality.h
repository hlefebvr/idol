...
#ifndef IDOL_OPTIMIZERS_STRONG_DUALITY_H
#define IDOL_OPTIMIZERS_STRONG_DUALITY_H
...
class idol::Optimizers::Bilevel::StrongDuality : public Algorithm {
...
#endif //IDOL_OPTIMIZERS_STRONG_DUALITY_H
