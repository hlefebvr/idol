...
#ifndef IDOL_KKT_BIGM_H
#define IDOL_KKT_BIGM_H
...
class BilevelMethods::KKT_BigM : public BilevelMethod {
public:
    [[nodiscard]] unsigned score() const override { return 2000; }
    [[nodiscard]] std::string name() const override { return "KKT_BigM"; }
