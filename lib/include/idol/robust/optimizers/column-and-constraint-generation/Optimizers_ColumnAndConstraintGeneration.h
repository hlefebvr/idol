...
class idol::Optimizers::Robust::ColumnAndConstraintGeneration : public Algorithm {
    ...
    std::vector<std::unique_ptr<idol::Robust::CCG::Separation>> m_separations;
    unsigned int m_separation_index = 0;
...
public:
    ...
    [[nodiscard]] const PrimalPoint& get_last_master_solution() const;
    ...
    [[nodiscard]] const idol::CCG::Formulation& get_formulation() const { return *m_formulation; }
