...
impl::Var::Var(ObjectId &&t_id, double t_lb, double t_ub, VarType t_type, Deprecated_Column&& t_column)
...
const Deprecated_Column &impl::Var::column() const {
    return m_column;
}

Deprecated_Column &impl::Var::column() {
    return m_column;
}
