...
class idol::Heuristics::IntegerMaster : public BranchAndBoundCallbackFactory<DefaultNodeInfo> {
...
public:
    ...
    [[nodiscard]] BranchAndBoundCallbackFactory<DefaultNodeInfo> *clone() const override;
