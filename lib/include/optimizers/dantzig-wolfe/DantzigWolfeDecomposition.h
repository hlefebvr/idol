...
public:
     ...
     */
    DantzigWolfeDecomposition& with_master_optimizer(const OptimizerFactory& t_master_optimizer);
     ...
     * @return the optimizer factory itself
     */
    DantzigWolfeDecomposition& with_pricing_optimizer(const OptimizerFactory& t_pricing_optimizer);
