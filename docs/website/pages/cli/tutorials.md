\page cli_tutorials Tutorials
\brief Describes the available tutorials for the `idol_cl` tool.

<span style="font-weight:500;">Mixed-Integer Optimization</span>

Also see \ref cli_input_format_milp
...
Also see \ref cli_input_format_robust