...
IDOL_CREATE_ATTRIBUTE_TYPE(Var, IDOL_double, 4)
IDOL_CREATE_ATTRIBUTE(Var, IDOL_double, 0, Lb, ::Var)
IDOL_CREATE_ATTRIBUTE(Var, IDOL_double, 1, Ub, ::Var)
IDOL_CREATE_ATTRIBUTE(Var, IDOL_double, 2, Value, ::Var)
IDOL_CREATE_ATTRIBUTE(Var, IDOL_double, 3, RedCost, ::Var)

IDOL_CREATE_ATTRIBUTE_TYPE(Var, IDOL_int, 3)
IDOL_CREATE_ATTRIBUTE(Var, IDOL_int, 0, Type, ::Var)
IDOL_CREATE_ATTRIBUTE(Var, IDOL_int, 1, Status, ::Var)
IDOL_CREATE_ATTRIBUTE(Var, IDOL_int, 2, Index, ::Var)
