...
#ifndef IDOL_OPTIMIZERS_DETERMINISTIC_H
#define IDOL_OPTIMIZERS_DETERMINISTIC_H
...
class idol::Optimizers::Robust::Deterministic : public Algorithm {
...
public:
    Deterministic(const Model& t_parent, const idol::Robust::Description& t_description, const OptimizerFactory& t_deterministic_optimizer);
...
#endif //IDOL_OPTIMIZERS_DETERMINISTIC_H
