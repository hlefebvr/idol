...
void idol::Optimizers::HiGHS::save_simplex_solution_status() {
    ...
    throw Exception("HiGHS: Unhandled solution status: " + std::to_string(status));
     */

}

void idol::Optimizers::HiGHS::compute_farkas_certificate() {
...
void idol::Optimizers::HiGHS::compute_unbounded_ray() {
...
void idol::Optimizers::HiGHS::save_milp_solution_status() {
