...
#include "idol/mixed-integer/optimizers/wrappers/HiGHS/headers/header_HConfig.h"
#include "idol/mixed-integer/optimizers/wrappers/HiGHS/headers/header_HighsInt.h"
