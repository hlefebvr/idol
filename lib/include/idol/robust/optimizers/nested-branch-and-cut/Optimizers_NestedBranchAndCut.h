...
class idol::Optimizers::Robust::NestedBranchAndCut : public Algorithm {
    class Formulation;
    ...
    std::unique_ptr<idol::Robust::NBC::Formulation> m_formulation;
public:
    NestedBranchAndCut(const Model& t_model,
