...
constexpr auto table_space = algorithm_space + problem_space + iteration_space + column_space;

void idol::DantzigWolfe::Loggers::Debug::Strategy::log_init(unsigned int t_n_sub_problems) {

    center(std::cout, "*", table_space, '*') << '\n';
    center(std::cout, " Dantzig-Wolfe Decomposition ", table_space) << '\n';
    center(std::cout, "*", table_space, '*') << '\n';

    center(std::cout, "Algorithm", algorithm_space);
    center(std::cout, "Problem", problem_space);
    center(std::cout, "Iteration", iteration_space);
    center(std::cout, "Columns", column_space);
    std::cout << '\n';
...
void
idol::DantzigWolfe::Loggers::Debug::Strategy::log_master(unsigned int t_iteration,
                                                         double t_total_time,
...
void
idol::DantzigWolfe::Loggers::Debug::Strategy::log_sub_problem(unsigned int t_iteration,
                                                              double t_total_time,
...
void idol::DantzigWolfe::Loggers::Debug::Strategy::log_end() {
    center(std::cout, "-", table_space, '-') << std::endl;
}

idol::DantzigWolfe::Loggers::Debug::Strategy::Strategy(unsigned int t_frequency) : m_frequency(t_frequency) {

}

idol::DantzigWolfe::Loggers::Debug &idol::DantzigWolfe::Loggers::Debug::with_frequency(unsigned int t_frequency) {
