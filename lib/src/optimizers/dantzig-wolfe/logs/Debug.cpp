...
idol::DantzigWolfe::Loggers::Debug::Strategy::Strategy(unsigned int t_frequency, bool t_log_sub_problems)
...
idol::DantzigWolfe::Loggers::Debug &idol::DantzigWolfe::Loggers::Debug::with_sub_problems(bool t_value) {
